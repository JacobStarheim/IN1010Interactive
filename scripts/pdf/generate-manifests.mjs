...
const exams = [
  {
    ...
    interactions: {
      ...
      8: {
        ...
        draggableItems: [
          { id: "q8_wrong_not_start", label: "neste != start" },
          { id: "q8_wrong_not_this", label: "neste != this" },
          { id: "q8_wrong_print_next", label: "System.out.println(neste)" },
          { id: "q8_wrong_rekursiv_arg", label: "skrivRekursivt(neste)" },
          { id: "q8_wrong_data_if", label: "data != null" },
          { id: "q8_wrong_backwards", label: "skrivBaklengs()" },
          { id: "q8_wrong_this", label: "this != null" },
  ...
  },
  {
    ...
    interactions: {
      2: {
        ...
        draggableItems: [
          { id: "q2_wrong_new_18", label: "b2 = new Brev(18);" },
          { id: "q2_assign", label: "b2 = b1" },
          { id: "q2_wrong_ctor_reverse", label: "vekt = this.v" },
          { id: "q2_ret", label: "vekt" },
          { id: "q2_wrong_ctor_to_v", label: "v = vekt" },
          { id: "q2_ctor", label: "vekt = v" },
          { id: "q2_wrong_neste", label: "neste.finnVekt()" },
          { id: "q2_wrong_direct_field", label: "b2.vekt" },
          { id: "q2_wrong_b1_field", label: "b1.vekt" },
          { id: "q2_new", label: "new Brev(19)" },
          { id: "q2_wrong_new_empty", label: "new Brev()" },
          { id: "q2_wrong_this_assign", label: "this.v = vekt" },
          { id: "q2_wrong_fn_arg", label: "finnVekt(b2)" },
          { id: "q2_wrong_b2", label: "b2" },
          { id: "q2_print", label: "b2.finnVekt()" },
          { id: "q2_wrong_b1_eq_b2", label: "b1 = b2" },
        ],
        dropZones: [
      ...
      3: {
        ...
        draggableItems: [
          ...
          { id: "q3_wrong_tastatur_println", label: "tastatur.println" },
          { id: "q3_wrong_null", label: "null" },
          { id: "q3_wrong_ten", label: "10" },
          { id: "q3_store_right", label: "v" },
          { id: "q3_zero", label: "0" },
          { id: "q3_while", label: "antallTall < 10" },
          { id: "q3_wrong_minus_one", label: "-1" },
          { id: "q3_store_left", label: "tallene[antallTall]" },
          { id: "q3_wrong_dec", label: "antallTall = antallTall - 1" },
          { id: "q3_wrong_non_negative", label: "v >= 0" },
          { id: "q3_read", label: "tastatur.nextInt()" },
          { id: "q3_print", label: "System.out.println" },
          { id: "q3_wrong_first_elem", label: "tallene[0]" },
          { id: "q3_wrong_for_forward", label: "int i = 0; i < tallene.length; i++" },
        ...
        dropZones: [
          ...
          { id: "q3_slot_6", label: "Plass 6", accepts: ["q3_store_left"] },
          { id: "q3_slot_7", label: "Plass 7", accepts: ["q3_store_right"] },
          { id: "q3_slot_8", label: "Plass 8", accepts: ["q3_inc"] },
          { id: "q3_slot_9", label: "Plass 9", accepts: ["q3_for"] },
          { id: "q3_slot_10", label: "Plass 10", accepts: ["q3_print"] },
          { id: "q3_slot_11", label: "Plass 11", accepts: ["q3_val"] },
        ],
      },
      5: {
        checkMode: "auto",
